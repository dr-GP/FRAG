...
static const struct SignatureZMove sSignatureZMoves[] =
    {
        ...
        {SPECIES_PIKACHU_ASH, ITEM_PIKANIUM_Z, MOVE_VOLT_TACKLE, MOVE_CATASTROPIKA},
        ...
        {SPECIES_PIKACHU_ASH, ITEM_PIKASHUNIUM_Z, MOVE_THUNDERBOLT, MOVE_10000000_VOLT_THUNDERBOLT},
