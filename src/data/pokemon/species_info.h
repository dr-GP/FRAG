...
#include "species_info/gen_9_families.h"
        ...
        [SPECIES_PIKACHU_ASH] = {
            ...
            .iconPalIndex = 0,
            OVERWORLD(sPicTable_Pikachu, SIZE_32x32, SHADOW_SIZE_M, TRACKS_FOOT, gOverworldPalette_Pikachu, gShinyOverworldPalette_Pikachu) FOOTPRINT(Pikachu).levelUpLearnset = sPikachuLevelUpLearnset,
